//Conrad Tempel Homework #4

$(document).ready(function() {
    var apiKey = "https://api.darksky.net/forecast/fe430e0c631ab18d428bd9caec6d21aa/37.8267,-122.4233" // Enter your API Key here
    ...
    $(document).ready(function(){
		Object.keys(state_info).forEach(function(state) {
			var url = 'https://api.darksky.net/forecast/fe430e0c631ab18d428bd9caec6d21aa/'+state_info[state]['lat']+','+state_info[state]['lng'];
			var temp=0;
